#!/bin/bash
#SBATCH --job-name=alpamayo_mismatch
...
#SBATCH --output=/mnt/slurm_nfs/a6abdulm/projects/alpamayo-r1-research/logs/mismatch_%j.out
#SBATCH --error=/mnt/slurm_nfs/a6abdulm/projects/alpamayo-r1-research/logs/mismatch_%j.err

echo "=========================================="
echo "REASONING-ACTION MISMATCH EXPERIMENT"
echo "Alpamayo-R1-10B in bfloat16"
echo "=========================================="
...
# Run the experiment
python src/run_mismatch_experiment.py \
    --output-dir results/mismatch_${SLURM_JOB_ID}
